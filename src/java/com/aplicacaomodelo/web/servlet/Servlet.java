...
import com.aplicacaomodelo.web.viewhelper.Livro_Visualizar;
...
public class Servlet extends HttpServlet {
    ...
    public Servlet() {
         ...
         */
        vhs.put("/WorkBook/ConsultarPessoa", new PessoaVH());
        ...
        vhs.put("/WorkBook/Visualizar_alterar", new Livro_Visualizar());
